...
public class RtcActivity extends Activity implements RtcClient.RtcListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //callerId="xjTHQJuAJof-CSRKAAAE";
    }

    private void init() {
        Point displaySize = new Point();
        getWindowManager().getDefaultDisplay().getSize(displaySize);
        RtcParameter params = new RtcParameter(
                true, false, displaySize.x, displaySize.y, 30, 1, VIDEO_CODEC_VP9, true, 1, AUDIO_CODEC_OPUS, true);

        client = new RtcClient(this, mSocketAddress, params, VideoRendererGui.getEGLContext());
    }
